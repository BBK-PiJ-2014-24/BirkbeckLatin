...
import com.newnham.app.birkbecklatin.Model.LatinConstants;
...
import static com.newnham.app.birkbecklatin.Model.LatinConstants.CONJNUM31;
...
import static com.newnham.app.birkbecklatin.Model.LatinConstants.NOUN_SKILL_LEVEL;
import static com.newnham.app.birkbecklatin.Model.LatinConstants.NOUN_THETA;
import static com.newnham.app.birkbecklatin.Model.LatinConstants.PREPOSITION;
import static com.newnham.app.birkbecklatin.Model.LatinConstants.TRANSLATION_DIRECTION;
...
public class DatabaseAccess {
    ...
    public String sqlEngAuxCompoundVerbQuery(String person, String number, String mood, String voice, String tense) {
        ...
        String engAuxVerb = cursor.getString(cursor.getColumnIndex(DbSchema.EnglishAuxillaryVerbTable.Cols.ENG_AUX_COMPOUND_VERB));
        cursor.close();
        return engAuxVerb;
    }
